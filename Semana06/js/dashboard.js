document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadTasks() {
        ...
        tasks.forEach(function (task) {
            //aqui vamos a tener un elemento del arreglo de tareas por cada uno de los elementos
        ...
        //selecciona todos los botones que tengas la clase edit-task
        document.querySelectorAll('.edit-task').forEach(function (btnEdit) {
            //para cada boton, vamos a manejar el evento click, este evento lo va a manejar la funcion handleEditTask
            //definida mas abajo
